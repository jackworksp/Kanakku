...
// Uses more expressive type scale with varied weights and larger display sizes
val ExpressiveTypography = Typography(
    // Display styles - Hero text for major numbers and headers
    ...
    // Label styles - Buttons, chips, and small UI elements
