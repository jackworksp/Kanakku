...
/**
 * Widget receiver for the Budget Progress widget.
 *
 * This receiver handles the lifecycle events for the medium widget (3x2) that displays
 * weekly budget progress with a visual progress bar. It serves as the entry point for
 * the Android system to interact with the widget.
 *
 ...
 *
 * The actual widget UI and data fetching is handled by [BudgetProgressWidget].
 *
 * @see BudgetProgressWidget
 ...
 * ```xml
 * <receiver
 *     android:name=".widget.BudgetProgressWidgetReceiver"
 ...
 *         android:resource="@xml/budget_progress_widget_info" />
 * </receiver>
 * ```
 */
class BudgetProgressWidgetReceiver : GlanceAppWidgetReceiver() {
     ...
     *
     * @return Instance of BudgetProgressWidget
     */
